...
public class UserManagementController {
    ...
    public ResponseEntity<?> deleteUser(@PathVariable Integer tenantUserId,@RequestHeader(value = "X-Tenant-Db", required = false) String tenantDb,
                                         @RequestHeader("X-Tenant-Role") String tenantRole){
        log.info("deleting user with id {} from hospital {}", tenantUserId, tenantDb);
        try{
